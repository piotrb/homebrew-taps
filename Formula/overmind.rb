class Overmind < Formula
  ...
  homepage "https://github.com/piotrb/overmind"
  ...
  head "https://github.com/piotrb/overmind.git"
  ...
  def install
    ...
    # Kernel.system "bash"
    system "go", "build", "-ldflags", "-s -w -X main.version=#{version}-piotrb", "-o", "#{bin}/overmind", "-v", "github.com/DarthSim/overmind"
  end
